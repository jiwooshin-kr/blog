...
- Yusuf, Jiang, Park. *The Safety-Aware Denoiser for Text Diffusion Models.* ICML 2026. [arXiv:2605.08116](https://arxiv.org/abs/2605.08116)
- Kim et al. *Training-free Safe Denoisers for Safe Use of Diffusion Models.* NeurIPS 2025.
- Nie et al. *Large Language Diffusion Models (LLaDA).* NeurIPS 2025.
- Sahoo et al. *Simple and Effective Masked Diffusion Language Models (MDLM).* NeurIPS 2024.
- Wen et al. *DIJA: a diffusion-specific jailbreak attack.* 2026.
- Zhang et al. *PAD: Parallel Decoding jailbreak.* 2025.
- Li et al. *DiffuGuard.* ICLR 2026.
- Singhal et al. *Feynman-Kac Steering.* 2025.
