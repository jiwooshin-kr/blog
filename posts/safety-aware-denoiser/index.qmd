...
> **Paper:** Amman Yusuf, Zhejun Jiang, Mijung Park. *The Safety-Aware Denoiser for Text Diffusion Models.* ICML 2026 (PMLR 306, Poster). [arXiv:2605.08116](https://arxiv.org/abs/2605.08116) · [OpenReview](https://openreview.net/forum?id=dw5BM3OQfZ) · [Code](https://github.com/ParkLabML/SAD)
...
SAD was accepted as a **Poster** at ICML 2026. The scores (via [Paper Copilot's open dataset](https://github.com/papercopilot/paperlists); ICML review text is not publicly posted, and [OpenReview](https://openreview.net/forum?id=dw5BM3OQfZ) now requires sign-in):
