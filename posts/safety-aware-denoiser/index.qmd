...
SAD was accepted as a **Poster** at ICML 2026, reviewed by four reviewers. The scores below are from [Paper Copilot's open dataset](https://github.com/papercopilot/paperlists); the review text is not publicly available (ICML does not post reviews, and [OpenReview](https://openreview.net/forum?id=dw5BM3OQfZ) requires sign-in), so they are reproduced here without interpretation.
