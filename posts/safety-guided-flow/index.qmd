...
4. **Composability.** Like SAD in the text domain, SGF is a plug-in: it stacks on SLD and SAFREE and improves both, rather than competing with them.
...
- Kim, Kim, Park. *Safety-Guided Flow: A Unified Framework for Negative Guidance in Safe Generation.* ICLR 2026. [arXiv:2603.13300](https://arxiv.org/abs/2603.13300)
- Kim et al. *Training-free Safe Denoisers for Safe Use of Diffusion Models.* NeurIPS 2025.
- Kirchhof et al. *Shielded Diffusion (SPELL): Generating Novel and Diverse Images using Sparse Repellency.* ICML 2025.
- Yoon et al. *SAFREE.* 2024. · Schramowski et al. *Safe Latent Diffusion (SLD).* 2023.
- Xiao et al. *SafeDiffuser.* 2025. · Dai et al. *Safe Flow Matching.* 2025.
- Yusuf, Jiang, Park. *The Safety-Aware Denoiser for Text Diffusion Models.* ICML 2026 — [my review](../safety-aware-denoiser/).
